...
from opencood.data_utils.datasets.intermediate_latency_fusion_dataset import getIntermediatelatencyFusionDataset
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert fusion_name in ['late', 'intermediate', 'intermediate2stage', 'intermediateLatency', 'early']

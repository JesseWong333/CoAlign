...
from opencood.utils.transformation_utils import x1_to_x2, x_to_world, get_pairwise_transformation_with_history
...
def getIntermediatelatencyFusionDataset(cls):
    """
    cls: the Basedataset.
    """

...
def main():
    ...
    pre_trained_path = './opencood/logs/dairv2x_point_pillar_lidar_deformable_attn_time_delay_2024_01_11_12_03_45/net_epoch15.pth'
    flow_model_path = "./flow_pred/checkpoint/checkpoint19.pth"
    main_model_dict = torch.load(pre_trained_path)
    flow_pred_model_dict = torch.load(flow_model_path)['model_state_dict']
    ...
    model.load_state_dict(main_model_dict, strict=True)
